...
warning('off','all');
%%
filename='J:\Elder Backup Raw Images\2016\2016-09\2016-09-01\09-01-2016_17_45_30_TopA.fits';
[Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFsort,P,zcor,Vsel]=EOS_Online( filename,...
    ...
    'Fudge',1.65,'BGSubtraction',0,'IfFitExpTail',1,'Nsat',inf,'IfBin',1,'BinGridSize',200,'SM',8,'CleanImage',1,'pixellength',0.7e-6);
nS1=nsort;
VS1=Vsort;
ZS1=Zsort;
%%
