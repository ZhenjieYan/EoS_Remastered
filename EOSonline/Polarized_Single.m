...
warning('off','all');
%%
filename='J:\Elder Backup Raw Images\2016\2016-08\2016-08-16\08-16-2016_16_29_36_TopA.fits';
[Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFsort,P,zcor,Vsel]=EOS_Online( filename,...
    ...
    'Fudge',1.5,'BGSubtraction',0,'IfFitExpTail',1,'Nsat',inf,'IfBin',1,'BinGridSize',160,'SM',4,'CleanImage',1,'pixellength',0.7e-6);
nS1=nsort;
VS1=Vsort;
ZS1=Zsort;
%%
