...
P=IdealGasFit( Vfit,nS1fit,[3000,250,1] );
...
%%
save('Result0804J.mat','T_trap','mu_trap_S1','VBinV','nS1BinV','nS2BinV','KappaTildeS1BinV','KappaTildeS2BinV')