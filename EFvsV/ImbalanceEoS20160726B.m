...
EFS2BinV=interp1(VS2BinV,EFS2BinV1,VBinV,'cubic');
...
Vfit=VBinZ(mask);
nS1fit=nS1BinZ(mask);
% Q=IdealGasFit( Vfit,nS1fit,[5000,500,1] )
% Q(3)
P=IdealGasFitwoFudge( Vfit,nS1fit,[5000,500] );
%%
mu_trap_S1=P(1)
T_trap=P(2)
...
%%
% Vaverage=VBinV;
% KappaTildeS2Average=KappaTildeS2BinV;
plot(Vaverage,KappaTildeS2Average,'ro','DisplayName','Averaging');xlim([0,3500]);
hold on
plot(VBinV,KappaTildeS2BinV,'bo','DisplayName','Averaging');
hold off
