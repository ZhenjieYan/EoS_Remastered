...
kB=1.380e-23;
Nsat=770;
load('/Users/Zhenjie/Data/Processed/2016-08-22/2016-08-22Set2Bin.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS1Final{i},'ROI1',[280,155,407,462],...
    'ROI2',[280,237,407,339],'TailRange',[180,380],'ShowOutline',1,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
...
for i=1:length(imglistS2Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS2Final{i},'ROI1',[280,155,407,462],...
    'ROI2',[280,285,407,295],'TailRange',[180,380],'ShowOutline',1,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
    ...
    'IfCleanImage',1,'OutlineExtrapolate',0,'OutlineIntrapolate',0,'Zaveraging',0,'IfExtrapolateAngle',1);%
