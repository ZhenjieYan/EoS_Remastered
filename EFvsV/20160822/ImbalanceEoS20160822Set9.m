...
kB=1.380e-23;
Nsat=inf;
load('/Users/Zhenjie/Data/Processed/2016-08-22/2016-08-22Set9.mat')
warning ('off','all')
...
for i=1:length(imglistS2Final)
    ...
    'ROI2',[850,830,1300,930],'TailRange',[500,1200],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
...
%%
save('Result0822Set9.mat','T_trap','mu_trap_S1','VBinV','nS1BinV','nS2BinV','KappaTildeS1BinV','KappaTildeS2BinV','EFS1BinV','EFS2BinV')