...
kB=1.380e-23;
Nsat=inf;
load('/Users/Zhenjie/Data/Processed/2016-08-29/2016-08-29Set7.mat')
warning ('off','all')
...
for i=1:length(imglistS2Final)
    ...
    'ROI2',[850,1480,1330,1744],'TailRange',[1370,1820],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
