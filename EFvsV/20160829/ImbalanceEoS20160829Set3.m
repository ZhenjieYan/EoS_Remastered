...
kB=1.380e-23;
Nsat=inf;
load('/Users/Zhenjie/Data/Processed/2016-08-29/2016-08-29Set3.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS1Final{i},'ROI1',[879,1279,1330,1920],...
    'ROI2',[850,1498,1330,1744],'TailRange',[1370,1820],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
...
for i=1:length(imglistS2Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS2Final{i},'ROI1',[879,1279,1330,1920],...
