...
kB=1.380e-23;
Nsat=770;
load('/Users/Zhenjie/Data/Processed/2016-09-16/2016-09-16Set1Bin.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS1Final{i},'ROI1',[320,265,456,600],...
...
for i=1:length(imglistS2Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS2Final{i},'ROI1',[320,265,456,600],...
    'ROI2',[320,440,456,450],'TailRange',[325,580],'ShowOutline',1,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
    ...
    'IfCleanImage',1,'OutlineExtrapolate',0,'OutlineIntrapolate',0,'Zaveraging',0,'IfExtrapolateAngle',0);%
