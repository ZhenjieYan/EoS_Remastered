...
kB=1.380e-23;
Nsat=770;
load('/Users/Zhenjie/Data/Processed/2016-09-08/2016-09-08Set5Bin.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS1Final{i},'ROI1',round([700,800,1310,1820]/3),...
    'ROI2',[233,405,437,475],'TailRange',round([1000,1650]/3),'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
    ...
    'IfCleanImage',1,'OutlineExtrapolate',0,'IfLookUpTable',1,'Zaveraging',1);
...
for i=1:length(imglistS2Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS2Final{i},'ROI1',round([700,800,1310,1820]/3),...
    'ROI2',round([700,1275,1310,1370]/3),'TailRange',round([1000,1650]/3),'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
    ...
    'IfCleanImage',1,'OutlineExtrapolate',0,'Zaveraging',0);%
...
figure1 = figure;
axes1 = axes('Parent',figure1,'unit','inch','position',[1,1,4,2.5]);
...
figure1 = figure;
axes1 = axes('Parent',figure1,'unit','inch','position',[1,1,4,3]);
