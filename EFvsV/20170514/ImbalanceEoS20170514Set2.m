...
kB=1.380e-23;
Nsat=770;
load('/Users/Zhenjie/Data/Processed/2017-05-14/2017-05-14Set2.mat')
warning ('off','all')
...
for i=1:length(imglistS2Final)
    ...
    'ROI2',[270,430,456,450],'TailRange',[325,580],'ShowOutline',1,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
    ...
    'IfCleanImage',1,'OutlineExtrapolate',0,'OutlineIntrapolate',1,'Zaveraging',0,'IfExtrapolateAngle',0);%
...
[KappaTildeS1BinV,KappaTildeS1ErrBinV]=FiniteD( VBinV,VBinV*0,EFS1BinV,EFS1ErrBinV,11);
