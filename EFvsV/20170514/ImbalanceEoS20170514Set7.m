...
kB=1.380e-23;
Nsat=770;
load('/Users/Zhenjie/Data/Processed/2017-05-14/2017-05-14Set7.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS1Final{i},'ROI1',[270,170,456,700],...
...
for i=1:length(imglistS2Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS2Final{i},'ROI1',[270,170,456,700],...
...
[KappaTildeS1BinV,KappaTildeS1ErrBinV]=FiniteD( VBinV,VBinV*0,EFS1BinV,EFS1ErrBinV,10);
