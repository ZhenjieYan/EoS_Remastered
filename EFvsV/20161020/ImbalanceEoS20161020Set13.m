...
load('/Users/Zhenjie/Data/Processed/2016-10-20/2016-10-20Set13Bin.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    ...
    'ROI2',[220,400,426,490],'TailRange',[325,580],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
...
for i=1:length(imglistS2Final)
    ...
    'ROI2',[270,430,456,450],'TailRange',[325,580],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
