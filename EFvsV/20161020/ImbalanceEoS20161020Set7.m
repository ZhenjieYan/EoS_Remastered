...
load('/Users/Zhenjie/Data/Processed/2016-10-20/2016-10-20Set7Bin.mat')
warning ('off','all')
...
for i=1:length(imglistS2Final)
    ...
    'ROI2',[270,420,456,460],'TailRange',[325,580],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
