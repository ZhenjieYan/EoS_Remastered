...
kB=1.380e-23;
Nsat=770;
load('/Users/Zhenjie/Data/Processed/2017-02-17/2017-02-17Set4Bin.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    ...
    'ROI2',[270,420,456,460],'TailRange',[325,580],'ShowOutline',i==1,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
...
for i=1:length(imglistS1Final)
    ...
    'ROI2',[270,420,456,462],'TailRange',[325,580],'ShowOutline',i==1,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
    'Fudge',Fudge,'BGSubtraction',0,'IfFitExpTail',0,'Nsat',Nsat,'ShowPlot',0,'CutOff',inf,'IfHalf',0,'pixellength',pixellength,'SM',3,'IfBin',0,'BinGridSize',150,...
    'IfCleanImage',1,'OutlineExtrapolate',1,'IfLookUpTable',1);
...
hold on
plot(ZBinZ,nS2BinZ,'color',[201,67,52]/255,'linewidth',2);
plot(ZBinZ,nS1BinZ,'color',[36,85,189]/255,'linewidth',2);
...
% 
line([25,25],[-25,25],'linewidth',0.75,'color','k');
line([75,75],[-25,25],'linewidth',0.75,'color','k');
line([125,125],[-25,25],'linewidth',0.75,'color','k');
line([-25,-25],[-25,25],'linewidth',0.75,'color','k');
line([-75,-75],[-25,25],'linewidth',0.75,'color','k');
line([-125,-125],[-25,25],'linewidth',0.75,'color','k');
line([-175,-175],[-25,25],'linewidth',0.75,'color','k');
line([175,175],[-25,25],'linewidth',0.75,'color','k');
box on
hold off
ylim([-0.05,0.2]);xlim([-175,175])
