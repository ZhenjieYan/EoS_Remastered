...
kB=1.380e-23;
Nsat=inf;
load('/Users/Zhenjie/Data/Processed/2016-09-01/2016-09-01set7.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    ...
    'ROI2',[850,1480,1330,1744],'TailRange',[1050,1900],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
...
figure1 = figure;
axes1 = axes('Parent',figure1,'unit','inch','position',[1,1,1.4,0.8]);
...
%%
figure1 = figure;
axes1 = axes('Parent',figure1,'unit','inch','position',[1,1,1.4,0.5]);
mask=abs(ZBinZ)<157;
...
hold off
set(axes1,'XColor',[0 0 0],'YColor',[0 0 0],'ZColor',[0 0 0],'Ytick',[0 0.2 0.4 0.6],'Xtick',[-200,-100,0,100,200])
ylabel('T/T_F');xlabel('Z');
xlim([-250,250]);ylim([0,0.7]);
...
line([Zth,Zth],[-1000,1000],'linewidth',0.5,'color',[62,166,60]/255);
line([-Zth,-Zth],[-1000,1000],'linewidth',0.5,'color',[62,166,60]/255);
