...
kB=1.380e-23;
Nsat=inf;
load('/Users/Zhenjie/Data/Processed/2016-09-01/2016-09-01Set6.mat')
warning ('off','all')
...
for i=1:length(imglistS2Final)
    ...
    'ROI2',[850,1548,1330,1690],'TailRange',[1050,1900],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
...
for i=1:length(imglistS2Final)
    ...
    'ROI2',[850,1548,1330,1690],'TailRange',[1470,1800],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
