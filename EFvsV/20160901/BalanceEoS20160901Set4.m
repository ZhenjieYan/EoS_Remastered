...
kB=1.380e-23;
Nsat=inf;
load('/Users/Zhenjie/Data/Processed/2016-09-01/2016-09-01Set4.mat')
warning ('off','all')
%%
[Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS1Final{1},...
    ...
    'Fudge',Fudge,'BGSubtraction',0,'IfFitExpTail',1,'Nsat',Nsat,'ShowPlot',1,'CutOff',inf,'IfHalf',0,'pixellength',pixellength,'SM',3,'IfBin',0,'BinGridSize',150,'IfCleanImage',1,'OutlineExtrapolate',0);
...
for i=1:length(imglistS1Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS1Final{i},'ROI1',[879,1325,1330,1920],...
    'ROI2',[850,1548,1330,1690],'TailRange',[1450,1800],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
...
for i=1:length(imglistS2Final)
    disp(i);
    [Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( imglistS2Final{i},'ROI1',[879,1325,1330,1920],...
    'ROI2',[850,1548,1330,1690],'TailRange',[1450,1800],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
...
%Zgrid=sort([Zgrid1(abs(Zgrid1)<90),Zgrid2(abs(Zgrid2)>90)]);
Zgrid=Zgrid2;
...
%% Kappa vs Z plot
figure1 = figure;
axes1 = axes('Parent',figure1,'unit','inch','position',[1,1,1.5,0.8]);
