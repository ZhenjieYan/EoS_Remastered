...
fileS1='07-26-2016_23_08_57_TopA.fits';
fileS2='07-26-2016_23_08_57_TopB.fits';
Fudge=1.32;
Nsat=120;
...
[Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( [filefolder,fileS1],'ROI1',[100,300,700,1175],...
    ...
    'Fudge',Fudge,'BGSubtraction',0,'IfFitExpTail',1,'Nsat',Nsat,'ShowPlot',1,'CutOff',inf,'IfHalf',0,'pixellength',pixellength,'SM',3,'IfBin',1,'BinGridSize',150);
nS1=nsort/1e18;
VS1=Vsort/hh;
...
[Pt,Kt,nsort,Vsort,Zsort,Ptsel,Ktsel,EFS1,P,zcor,Vsel]=EOS_Online( [filefolder,fileS2],'ROI1',[100,350,700,1050],...
    ...
    'Fudge',Fudge,'BGSubtraction',0,'IfFitExpTail',1,'Nsat',Nsat,'ShowPlot',1,'CutOff',inf,'IfHalf',0,'pixellength',pixellength,'SM',4,'IfBin',1,'BinGridSize',100);
nS2=nsort/1e18;
VS2=Vsort/hh;
...
plot(Vgrid,nS1Ideal+0.615*nS2grid,'k--','linewidth',2,'displayname','n_{1,Ideal} - A\timesn_2, A=-0.307');
hold off
