...
kB=1.380e-23;
Nsat=770;
load('/Users/Zhenjie/Data/Processed/2016-09-07/2016-09-07Set1Bin.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    ...
    'IfCleanImage',1,'OutlineExtrapolate',1,'IfLookUpTable',1,'Zaveraging',0);
...
for i=1:length(imglistS2Final)
    ...
    'ROI2',[233,429,437,454],'TailRange',round([1000,1650]/3),'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
