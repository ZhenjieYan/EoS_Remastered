...
kB=1.380e-23;
Nsat=770;
load('/Users/Zhenjie/Data/Processed/2017-02-16/2017-02-16Set2ABin.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    ...
    'ROI2',[270,414,456,469],'TailRange',[325,580],'ShowOutline',i==1,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
