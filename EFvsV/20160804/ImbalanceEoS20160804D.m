...
P=IdealGasFit( Vfit,nS1fit,[3000,1000,1] );
P(3)
%%
...
%%
save('Result0804D.mat','T_trap','mu_trap_S1','VBinV','nS1BinV','nS2BinV','KappaTildeS1BinV','KappaTildeS2BinV')