...
P=IdealGasFit( Vfit,nS1fit,[2000,230,1] );
...
KappaFitZ=interp1(beta_mu_T,KappaTildeT,beta_mu_localZ);
...
%%
save('Result0804L.mat','T_trap','mu_trap_S1','VBinV','nS1BinV','nS2BinV','KappaTildeS1BinV','KappaTildeS2BinV')