...
kB=1.380e-23;
Nsat=inf;
load('/Users/Zhenjie/Data/Processed/2016-08-30/2016-08-30Set17RotBin.mat')
warning ('off','all')
...
for i=1:length(imglistS2Final)
    ...
    'ROI2',[200,518,600,630],'TailRange',[350,700],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
