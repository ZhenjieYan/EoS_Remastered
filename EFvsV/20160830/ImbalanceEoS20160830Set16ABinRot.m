...
kB=1.380e-23;
Nsat=770;
load('/Users/Zhenjie/Data/Processed/2016-08-30/2016-08-30Set16ABinRot.mat')
warning ('off','all')
...
for i=1:length(imglistS1Final)
    ...
    'ROI2',[270,500,500,620],'TailRange',[475,675],'ShowOutline',i==1,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
